...
// node_modules/aframe-mountain-component/lib/ImprovedNoise.js
var require_ImprovedNoise = __commonJS({
  "node_modules/aframe-mountain-component/lib/ImprovedNoise.js"(exports, module) {
    var ImprovedNoise2 = function() {
      var p = [
        151,
        160,
        137,
    ...
    module.exports = ImprovedNoise2;
  }
});

// node_modules/aframe-mountain-component/index.js
var ImprovedNoise = require_ImprovedNoise();
AFRAME.registerComponent("mountain", {
  ...
  update: function() {
    ...
    var canvas = generateTexture(
      ...
      new THREE.Color(data.shadowColor),
      data.sunPosition
    );
    ...
    geometry.translate(
      0,
      -1 * (terrainData[worldWidth / 2 + worldDepth / 2 * worldWidth] * 10 + 500),
      0
    );
...
function generateTexture(terrainData, width, height, color, colorShadow, sunPos) {
  ...
  for (var i = 0, j = 0, l = imageData.length; i < l; i += 4, j++) {
    ...
    imageData[i] = (red + shade * redShadow) * (0.5 + terrainData[j] * 7e-3);
    imageData[i + 1] = (green + shade * blueShadow) * (0.5 + terrainData[j] * 7e-3);
    imageData[i + 2] = (blue + shade * greenShadow) * (0.5 + terrainData[j] * 7e-3);
  }
...
//# sourceMappingURL=aframe-mountain-component.js.map
